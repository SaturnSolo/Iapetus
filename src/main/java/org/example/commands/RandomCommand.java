...
public class RandomCommand extends IapetusCommand {
	...
	public boolean runCommand(SlashCommandInteractionEvent event) {
		List<String> compliments = Arrays.asList("**🍓**", "**Sending all the hugs**", "**Don't forget to eat**",
				"**The world may be hard but keep going**", "**Send love to the moss!**", "**I am but a moss moon**",
				"**You are amazing**", "**You are doing great**", "**I hope you are having a lovely day**",
				"**You're more helpful than you realize**", "**Your kindness is a balm to all who encounter it**",
				"**You're great at figuring stuff out**", "**Your creative potential seems limitless**",
				"**You are making a difference**", "**Our community is better because you're in it**",
